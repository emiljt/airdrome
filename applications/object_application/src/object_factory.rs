...
pub fn create_object(name: &str, description: &str, languages: Vec<&str>, targets: Vec<&str>)
    ...
    Ok(Object::new(new_id, new_name, new_description, new_languages, new_targets))
}

pub fn restore_object(id: &str, name: &str, description: &str, languages: Vec<&str>,
    targets: Vec<&str>) -> Result<Object, &'static str> {
